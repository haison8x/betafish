...
jQuery(".play-controller-moves-container").off('click')
jQuery('#board-layout-player-bottom').off('click')
jQuery(".play-controller-moves-container").on('click', function () {

    if (isThinking) {
        return false;
    }

    jQuery('.user-username-component').text("thinking ..................")

    isThinking = true;
    setTimeout(chessHint, 100);
